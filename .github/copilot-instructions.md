...
- Ralph source checkout on this machine: `/Users/tjegbejimba/Code/ralph-loop-dashboard`
- Repo worker prompt: `.ralph/RALPH.md`
- Repo config: `.ralph/config.json`
- Refresh scripts: `/Users/tjegbejimba/Code/ralph-loop-dashboard/install.sh "/Users/tjegbejimba/Code/kindleflow" --scripts-only`
